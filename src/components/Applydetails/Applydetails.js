      ...
      <div className="d-flex flex-column flex-md-row border justify-content-between align-items-center rounded shadow p-4">
        ...
        <div className="card-body">
          ...
          <div className="d-flex flex-column flex-md-row">
            <p className=' fw-bold me-4 text-gray'><FaSearchLocation /> {address}</p>
            <p className=' fw-bold text-gray'><FaDollarSign />Salary: {salary}</p>
          </div>
        </div>
        <div className='ms-auto'>
          <button onClick={handleViewDetails} className="details me-md-2">View Details</button>
        </div>
      </div>
    </div>
